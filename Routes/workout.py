...
from Controllers import create_workout_controller, get_all_workouts, get_todays_workout
...
async def all_workouts(db_session: Session = Depends(get_db)) -> List[WorkoutRead]:
