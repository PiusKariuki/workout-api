"""updateing with autogenerate

Revision ID: 4441caea8146
Revises: 52c9f7ee3d52
Create Date: 2023-10-24 21:06:03.211145
...
revision: str = '4441caea8146'
down_revision: Union[str, None] = '52c9f7ee3d52'
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['id'], ['user.id'], name='user_id'),
